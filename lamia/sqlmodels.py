...
class User(db.Model):
    ...
    post_count = db.Column(db.Integer, index=True)
    topic_count = db.Column(db.Integer, index=True)
    status_update_created = db.Column(db.Integer, index=True)
    status_update_comments_created = db.Column(db.Integer, index=True)
    boops_given = db.Column(db.Integer, index=True)
    boops_received = db.Column(db.Integer, index=True)
