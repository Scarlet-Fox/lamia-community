"""
Django settings for woe project.
...
SECRET_KEY = ')gc7_i2ik^lnqupm9=qna&86@k!1l(%hhiqg^(ww6i15$qfhzr'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.contrib.auth.context_processors.auth',
                'django.contrib.messages.context_processors.messages',
                'forum.context_processors.profile_processor'
            ],
            'loaders': [
...
WSGI_APPLICATION = 'woe.wsgi.application'
