...
(function() {
  $(function() {
    var page, paginationHTMLTemplate, paginationTemplate, resultTemplate, resultTemplateHTML, updateSearch;
    ...
    updateSearch = function() {
      ...
      return $.post("/search", JSON.stringify(data), function(data) {
        var _html, i, j, k, l, len, len1, m, max_pages, n, pages, pagination_html, ref, ref1, ref2, ref3, ref4, ref5, result, results, results1, results2, results3, term, term_re, terms;
        _html = "";
        ref = data.results;
        ...
        return $(".search-pagination").html(pagination_html);
      });
    };
