...
def character_database():
    return render_template("roleplay/characters.jade", page_title="Characters - Casual Anime")
...
def character_gallery(slug):
    ...
    return render_template("roleplay/character_gallery.jade", character=character, images=images, emotes=emotes, page_title="%s's Gallery - Character Database - Casual Anime" % unicode(character.name))
...
def manage_gallery(slug):
    ...
    return render_template("roleplay/manage_gallery.jade", character=character, images=images, page_title="Edit %s's Gallery - Character Database - Casual Anime" % unicode(character.name))
...
def create_character():
    ...
    return render_template("roleplay/new_character.jade", form=form, page_title="Create a Character - Casual Anime")
...
def character_edit_profile(slug):
    ...
    return render_template("roleplay/edit_character_profile.jade", character=character, form=form, page_title="Editing %s - Character Database - Casual Anime" % (unicode(character.name),))
...
def character_recent_activity(slug):
    ...
    return render_template("roleplay/character_posts.jade", character=character, page_title="%s - Character Database - Casual Anime" % (unicode(character.name),))
