...
roll_re = re.compile(r'(\[roll=(\d+)d(\d+)(?:\+(\d+)|\-(\d+))?\](.*?)\[\/roll\])', re.DOTALL|re.I)
attachment_re = re.compile(r'\[attachment=(.+?):(\d+)(:wrap)?\]')
spoiler_re = re.compile(r'\[spoiler\](.*?)\[\/spoiler\]', re.DOTALL|re.I)
center_re = re.compile(r'\[center\](.*?)\[\/center\]', re.DOTALL|re.I)
image_re = re.compile(r'\[img\](.*?)\[\/img\]', re.DOTALL|re.I)
quote_re = re.compile(r'\[quote=?(.*?)\](.*?)\[\/quote\]', re.DOTALL|re.I)
font_re = re.compile(r'\[font=?(.*?)\](.*?)\[\/font\]', re.DOTALL|re.I)
color_re = re.compile(r'\[color=?(.*?)\](.*?)\[\/color\]', re.DOTALL|re.I)
size_re = re.compile(r'\[size=?(.*?)\](.*?)\[\/size\]', re.DOTALL|re.I)
url_re = re.compile(r'\[url=?("?)(.*?)("?)\](.*?)\[\/url\]', re.DOTALL|re.I)
bold_re = re.compile(r'\[b\](.*?)\[\/b\]', re.DOTALL|re.I)
italic_re = re.compile(r'\[i\](.*?)\[\/i\]', re.DOTALL|re.I)
strike_re = re.compile(r'\[s\](.*?)\[\/s\]', re.DOTALL|re.I)
img_re = re.compile(r'\[img\](.*?)\[\/img\]', re.DOTALL|re.I)
